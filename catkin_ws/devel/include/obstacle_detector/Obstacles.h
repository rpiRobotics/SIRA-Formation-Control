...
struct Obstacles_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::obstacle_detector::SegmentObstacle_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::obstacle_detector::SegmentObstacle_<ContainerAllocator> >> _segments_type;
  _segments_type segments;

   typedef std::vector< ::obstacle_detector::CircleObstacle_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::obstacle_detector::CircleObstacle_<ContainerAllocator> >> _circles_type;
